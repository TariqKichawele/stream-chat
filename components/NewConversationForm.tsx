...
export default function NewConversationForm({ onSuccess }: { onSuccess: () => void }) {
  ...
  const { register, setValue, getValues, handleSubmit, formState: { errors, isSubmitting } } = useForm<Inputs>({
  ...
  function removeUser(id: string) {
    const value = selectedUsers.filter((userId: string) => userId !== id)
    setValue('selectedUsers', value, { shouldValidate: true })
  }
